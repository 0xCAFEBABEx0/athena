...
> = ({ className, ref, ...props }) => (
  <div
    className={cn('card bg-base-200 text-card-foreground shadow-sm border border-border', className)}
    ref={ref}
    {...props}
  />
)
...
const CardHeader: React.FC<
  { ref?: React.Ref<HTMLDivElement> } & React.HTMLAttributes<HTMLDivElement>
> = ({ className, ref, ...props }) => (
  <div className={cn('card-body flex flex-col space-y-1.5 p-6', className)} ref={ref} {...props} />
)
